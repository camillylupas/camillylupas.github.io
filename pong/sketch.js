...
let corMinhaRaquete = [255,100,255];

//Váriaveis Raquete do Oponente
let xRaqueteOponente = 0;
let yRaqueteOponente = 150;
let corRaqueteOponente = [255,100,0];
...
function draw() {
  ...
  //não forem maiores ou iguais a 10,então
  //joga!
